        ...
        <script type="text/javascript" src="<?php echo BASE_URL; ?>public/app/js/jquery.mmenu.js"></script>
        <script type="text/javascript" src="<?php echo BASE_URL; ?>public/app/js/utilidades.js"></script>
        <script type="text/javascript" src="<?php echo BASE_URL; ?>public/app/js/bootstrap.js"></script>
...
$(document).ready(function(){
    $("#frmdirector_ins_numdoc" ).keydown(function( event ) {        
      if ( event.which == 13 ) {
       $("#frmdirector_ins_numdoc" ).focus().select();
      }
    });
})
</script>
